...
var GlobalStore = /*#__PURE__*/React__default.createContext({});
...
var Search = /*#__PURE__*/styled(antd.Input.Search)( /*#__PURE__*/_templateObject2());
...
var ApiList = /*#__PURE__*/function (_React$Component) {
  ...
  function ApiList() {
    ...
    _this.renderBody = function (context) {
      ...
      return React__default.createElement(Wrapper, null, React__default.createElement(Title, null, name), React__default.createElement(Search, {
        placeholder: "\u641C\u7D22\u63A5\u53E3",
        onKeyUp: _this.onKeyUp
      }), React__default.createElement(List, null, filteredApis.map(function (api) {
        ...
        }, api.method), React__default.createElement(Url, null, api.path));
      })));
    };
  ...
  _proto.render = function render() {
    ...
    return React__default.createElement(GlobalStore.Consumer, null, function (context) {
...
var IconToggle = /*#__PURE__*/styled(antd.Icon)( /*#__PURE__*/_templateObject6$1());
var IconFile = /*#__PURE__*/styled(antd.Icon)( /*#__PURE__*/_templateObject7$1());
...
var TreeNode = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return React__default.createElement(Item$1, {
      title: tips
    }, React__default.createElement(reactContextmenu.ContextMenuTrigger, {
      id: "leaf-api-menu",
    ...
    }, renderToggle(type, this.state.visible), renderIcon(type), React__default.createElement(Name, null, title), method && React__default.createElement(Method$1, null, ".", method.toLowerCase()))), React__default.createElement(Leaf, {
      style: style
    }, treeNodes));
  };
...
function renderIcon(type) {
  return type === 'file' ? React__default.createElement(IconFile, {
    type: "file-text"
  }) : React__default.createElement(IconFile, {
    type: "folder"
  });
}
...
function renderToggle(type, visible) {
  ...
  return visible ? React__default.createElement(IconToggle, {
    type: "down"
...
var Tree = /*#__PURE__*/function (_React$Component) {
  ...
  function Tree() {
    ...
    _this.renderBody = function (context) {
      ...
      return React__default.createElement(Wrapper$1, null, React__default.createElement(reactContextmenu.ContextMenu, {
        className: "leaf-api-menu",
        id: "leaf-api-menu"
      }, React__default.createElement(reactContextmenu.MenuItem, {
        data: {
          action: 'create'
        },
      ...
      }, "\u65B0\u5EFA\u63A5\u53E3"), React__default.createElement(reactContextmenu.MenuItem, {
        data: {
          action: 'delete'
        },
        onClick: function onClick(data) {
      ...
      }, "\u5220\u9664")), React__default.createElement("ul", null, React__default.createElement(TreeNode, {
        onSelect: onSelect,
        node: data
      })));
    };
...
function () {
  var LeafMenu = /*#__PURE__*/function (_Component) {
    ...
    _proto.render = function render() {
      ...
      return React__default.createElement(GlobalStore.Provider, {
        value: _extends({}, this.props)
      }, React__default.createElement(Wrapper$2, null, React__default.createElement(antd.Tabs, {
        tabBarExtraContent: tabBarExtraContent
      }, React__default.createElement(TabPane, {
        tab: "\u6811\u5F62",
        key: "1"
      }, React__default.createElement(Tree, null)), React__default.createElement(TabPane, {
        tab: "\u5217\u8868",
        key: "2"
      }, React__default.createElement(ApiList, null)))));
    };
...
exports.default = LeafMenu;
//# sourceMappingURL=leaf-menu.cjs.development.js.map
